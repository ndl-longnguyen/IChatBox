...
AI_LOCAL_MODEL = os.getenv("AI_LOCAL_MODEL", "qwen2.5:1.5b")
AI_LOCAL_TIMEOUT_SECONDS = int(os.getenv("AI_LOCAL_TIMEOUT_SECONDS", "30"))
AI_LOCAL_MAX_TOKENS = int(os.getenv("AI_LOCAL_MAX_TOKENS", "160"))
AI_LOCAL_NUM_CTX = int(os.getenv("AI_LOCAL_NUM_CTX", "1024"))
